...
- **Background Blur**: select one picture, then create a sharp full-slide foreground with a blurred slide background.
...
- **Recover**: remove glass effects generated by this add-in and restore the original shape appearance as much as possible.
